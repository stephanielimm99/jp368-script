...
function createApkBox() {
  ...
  wrap.innerHTML = `
    <div class="maxwin-box">
      <div class="left-panel">
        ...
        <select id="altLink">
          <option value="https://link1.akses-terjamin.com">link resmi 1</option>
          <option value="https://link2.akses-terjamin.com">link resmi 2</option>
          <option value="https://link3.akses-terjamin.com">link resmi 3</option>
        </select>
  ...
  if (copyMainLinkBtn) {
    copyMainLinkBtn.addEventListener("click", function () {
      const value = "https://altwin.link/jp368";
